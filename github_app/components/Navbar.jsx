...
const Navbar = ({ setUsername }) => {
  ...
  return (
    <div className="fixed animate-expand z-10 w-full h-16 bg-[#161B22] shadow-sm shadow-gray-900 flex items-center px-5 0 top-0 left-0">
      <div className="flex animate-fade-up animate-once animate-delay-[3s] w-full items-center gap-10 justify-between">
